...
//     /**
//      * fcm token: get from user, so we need to query first to get the user
//      * title: template
//      * body: get the amount of infaq and combine it with the template
//      * imageUrlLink = null
//      * data: get the infaq model
//      */
...
//       return res
//         .status(200)
//         .json({ error: "Webhook successful but user fcm token not found" });

//     const title = `Infaq ${infaqUpdated.status}`;
//     const body = `Infaq sebesar Rp. ${infaqUpdated.amount.toLocaleString()} telah ${infaqUpdated.status}`;
//     const imageUrl = null;
//     // const data = JSON.stringify(infaqUpdated);
